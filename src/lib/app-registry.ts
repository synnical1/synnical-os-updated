export const SYNNICAL_APPS = [
  ...
  { id: "friends", label: "Friends", aliases: ["contacts", "friend"], authOnly: true },
  ...
  { id: "synnime", label: "Synnime", aliases: ["anime", "ani", "manga"] },
  ...
  { id: "creator", label: "Creator Studio", aliases: ["create", "studio"], authOnly: true },
