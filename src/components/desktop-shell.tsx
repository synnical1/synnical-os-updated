...
export function DesktopShell({ apps, renderPanel, onActivePanel }: {
  ...
  useEffect(() => { document.documentElement.dataset.synnicalAppearance = os.appearanceMode }, [os.appearanceMode])
  useEffect(() => {
